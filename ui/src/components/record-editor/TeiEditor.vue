...
export default defineComponent({
  ...
  setup() {
    ...
    //       currentPageData.value.transcriptionId,
    //       currentPageData.value.transcriptionVersion,
    //     ),
    //   );
    //   if (status.value !== 200) {
    //     if (status.value === 205) {
    //       console.log(data.value);
    //       currentPageData.value.transcriptionVersion = data.value.transcriptionVersion;
    //       currentPageData.value.transcriptionAuthor = data.value.transcriptionAuthor;
    //       currentPageData.value.transcriptionText = data.value.transcriptionText;
    //       return true;
    //     } else {
    ...
    //     currentPageData.value.tei = editor.getValue();
    //     resolve();
    //   });
    // };
    ...
    //       if (result) {
    //         editor.setSession(currentPageData.value.editorSession);
    //         resolve();
    //       } else {
    ...
    // const createSession = () => {
    //   return new Promise((resolve) => {
    //     currentPageData.value.editorSession = ace.createEditSession(currentPageData.value.tei);
    //     loadSession().then(() => {
    //       editor.session.once("change", () => (currentPageData.value.hasChanges = true));
