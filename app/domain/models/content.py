...
class ContentTypeExtended(ContentType):
    ...
    attribute_types = models.ManyToManyField('domain.AttributeType', through='domain.ContentAttributes')
...
class ContentAttributes(TrackingMixin):
    ...
    override_options = models.ForeignKey('domain.OptionsList', on_delete=models.SET_NULL, null=True)
