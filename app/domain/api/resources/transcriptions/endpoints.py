...
from domain.models import PageNode, Transcription
...
class TranscriptionAccessPolicy(BaseAccessPolicy):
    ...
    def get_parent(self, target):
        ...
        return (target.pagenodes.all()[0].record, RecordAccessPolicy())
...
class Transcriptions(viewsets.ModelViewSet):
    ...
    def create(self, request, fmt=None):  # noqa: ARG002
        ...
        if serializer.is_valid():
            ...
            sp = PageNode.objects.get(record=request.data['record'], page=request.data['page'])
