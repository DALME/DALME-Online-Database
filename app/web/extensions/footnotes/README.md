...
- Add the `FootnotesPlaceMarker` block to any StreamField where footnotes should be available:

- Also ensure that any page where footnotes are to be used inherits from `FootnoteMixin`:
