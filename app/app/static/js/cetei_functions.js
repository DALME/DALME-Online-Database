  ...
  "tei": {
    "ab": [
      ["[type=column]", function(e) {
         ...
         div.innerHTML = `<div><span class="label">C${colNum}</span><i class="fa fa-caret-down">
         </i><i class="fa fa-caret-right"></i></div>`;
