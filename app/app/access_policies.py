...
class BaseAccessPolicy(AccessPolicy):
    ...
    def get_policy_statements(self, request, view):  # noqa: ARG002
        ...
        with pathlib.Path(f'{settings.PROJECT_ROOT}/authorization/policies/{self.id}.json').open() as policy:
...
class WebAccessPolicy(BaseAccessPolicy):
    """Access policies for websites."""
