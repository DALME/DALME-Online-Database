...
class Migration(migrations.Migration):
    ...
    operations = [
        # The following SQL statements are a workaround for an issue filtering
        # over generic relations in postgres when UUID foreign keys are stored
        # in text/char fields. This is a known and long-standing bug in Django:
        # https://code.djangoproject.com/ticket/16055#no2
        # The problem still exists, despite being ostensibly fixed with a patch
        # in 2023:
