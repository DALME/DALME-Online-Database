...
def set_record_permissions(apps, schema_editor):
...
def create_credit_support_records(apps, schema_editor):
...
def migrate_record_credits(apps, schema_editor):
    ...
    for record in SourceCredits.objects.all():
        new_rel = Relationship(
            ...
            rel_type=authorship,
            notes=record.note or 'Stubbed notes field...',
