function setupTranscriber() {
    ...
    renderer_container = document.getElementById('text_render');
    editor_mode = 'renderer';
...
function editor(mode, target_idx) {
...
function viewer(mode, target_idx) {
