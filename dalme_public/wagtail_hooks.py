...
def extra_admin_css():
    return format_html(
        ...
        static('css/dalme_public/dalme_public_admin.css'),
    )
...
def global_admin_js():
    return format_html(
        '<script src="https://cdn.jsdelivr.net/npm/snarkdown@2.0.0/dist/snarkdown.umd.js" integrity="sha256-QqCCWG2y306e9DZ9VbcdrkacMAz1nubFmYCkac3I3AM=" crossorigin="anonymous"></script> \
        ...
        static('js/dalme_app/dalme_util.js'),
...
def register_add_ons(features):
    ...
    features.register_converter_rule(
        ...
        'link',
        {
            ...
            'to_database_format': {'entity_decorators': {'LINK': link_entity_decorator}},
        },
    )
...
def register_footnote(features):
    ...
    features.register_editor_plugin(
        ...
        draftail_features.EntityFeature(
            control, js=['js/dalme_public_footnote.js'], css={'all': ['css/dalme_public/dalme_public_footnote.css']}
        ),
    )
