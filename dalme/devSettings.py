...
CSRF_TRUSTED_ORIGINS = [
    ...
    "purl.127.0.0.1.sslip.io:8443",
    "purl.127.0.0.1.sslip.io:8000",
    "purl.127.0.0.1.sslip.iohttp://localhost:8888",
]
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://purl.127.0.0.1.sslip.iohttp://localhost:8888",
]
        ...
        "idp": {
            ...
            "endpoints": {
                "single_sign_on_service": [
                    (
                        "https://127.0.0.1.sslip.io:8443/idp/sso/post/",
                        saml2.BINDING_HTTP_POST,
                    ),
                    (
                        "https://127.0.0.1.sslip.io:8443/idp/sso/redirect/",
                        saml2.BINDING_HTTP_REDIRECT,
                    ),
                ],
                "single_logout_service": [
                    (
                        "https://127.0.0.1.sslip.io:8443/idp/slo/post/",
                        saml2.BINDING_HTTP_POST,
                    ),
                    (
                        "https://127.0.0.1.sslip.io:8443/idp/slo/redirect/",
                        saml2.BINDING_HTTP_REDIRECT,
                    ),
                ],
            },
