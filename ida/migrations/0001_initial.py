...
import ida.context
import ida.models.utils.attribute_field
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'same_as',
                    models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='ida.attributetype'),
                ),
            ],
            options={
                'ordering': ['id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', ida.models.utils.attribute_field.AttributeField()),
                (
                    'content_type',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concept', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ida.concept')),
                (
                    'creation_user',
                    models.ForeignKey(
                        default=django_currentuser.middleware.get_current_user,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ida.preferencekey')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='record',
            name='pages',
            field=models.ManyToManyField(db_index=True, through='ida.PageNode', to='ida.page'),
        ),
        migrations.AddField(
            model_name='record',
            name='parent_type',
        ...
        migrations.AddField(
            ...
            name='record',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, related_name='pagenodes', to='ida.record'
            ),
        ),
        migrations.CreateModel(
            name='RecordGroup',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'attachments',
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='ida.attachment'
                    ),
                ),
                (
                    'creation_user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(blank=True, related_name='tasks', to='ida.attachment')),
                (
                    'modification_user',
                    models.ForeignKey(
                        default=django_currentuser.middleware.get_current_user,
                ...
                ('resources', models.ManyToManyField(blank=True, related_name='tasks', to='ida.collection')),
                (
                    'task_list',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='tasks', to='ida.tasklist'
                    ),
                ),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ida.tenant')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'tenant',
                    models.OneToOneField(null=True, on_delete=django.db.models.deletion.PROTECT, to='ida.tenant'),
                ),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'op_list',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='values', to='ida.optionslist'
                    ),
                ),
                ('tenant', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ida.tenant')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(blank=True, related_name='tickets', to='ida.attachment')),
                (
                    'modification_user',
                    models.ForeignKey(
                        default=django_currentuser.middleware.get_current_user,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.CharField(default=ida.context.get_current_username, max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headword', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ida.headword')),
                (
                    'modification_user',
                    models.ForeignKey(
                        default=django_currentuser.middleware.get_current_user,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wordform', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='ida.wordform')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'record',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='work_log', to='ida.workflow'
                    ),
                ),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'collection',
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name='members', to='ida.collection'
                    ),
                ),
                (
                    'content_type',
